...
$id_producto_actual = 2; // ID para "Taza Pequeña"
$nombre_producto_actual = "Taza Pequeña";
$precio_producto_actual_display = "10.000";
$imagen_producto_actual = "../img/2.png";
$descripcion_producto_lead = "Disfruta de tus bebidas con el estilo de Tractores Clavijo.";
$descripcion_larga_producto = "Esta taza de cerámica resistente es perfecta para tu café de la mañana o tu té de la tarde, mostrando con orgullo el logo de Tractores Clavijo. Un regalo ideal para cualquier fanático de la marca o para agregar a tu colección.";
$caracteristicas_producto = [
    "Material: Cerámica de alta calidad.",
    "Capacidad: 330 ml.",
    "Diseño: Logo estampado duradero, apto para lavavajillas y microondas.",
    "Confort: Asa ergonómica para un agarre cómodo."
];
$colores_disponibles_para_este_producto = ["Blanco", "Negro", "Verde"];
// Este producto no tiene talles ni tipo de mate seleccionables por el usuario.
...
<head>
    ...
    <link rel="stylesheet" href="taza.css" />
</head>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNavProductPage">
                    <ul class="navbar-nav align-items-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo (strpos($_SERVER['PHP_SELF'], 'merch.php') !== false || strpos($_SERVER['PHP_SELF'], 'taza.php') !== false ? 'active' : ''); ?>" href="<?php echo $project_root_segment; ?>/frontend/merch/merch.php">Merch</a>
                        </li>

                        <?php if (isset($_SESSION['user_id'])): ?>
                            <li class="nav-item dropdown ms-lg-3">
                                <a class="nav-link dropdown-toggle btn btn-user-dropdown" href="#" id="navbarUserDropdownTaza" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    Hola, <?php echo htmlspecialchars($_SESSION['user_nombre']); ?> <i class="bi bi-person-circle ms-1"></i>
                                </a>
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarUserDropdownTaza">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 product-detail-info">
                        ...
                        <form action="../../../backend/php/cart_handler.php" method="POST" class="mt-4">
                            ...
                            <?php // La taza no tiene talles, pero sí colores 
                            ?>
