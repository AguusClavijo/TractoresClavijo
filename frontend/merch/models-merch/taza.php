...
<head>
    ...
    <title>Taza - Tractores Clavijo</title>
    ...
    <link rel="stylesheet" href="../merch.css" />  <link rel="stylesheet" href="taza.css" />   </head>
<body class="merch-page"> <header>
    ...
    <main style="padding-top: var(--navbar-height);">
        ...
        <section class="merch-header">
            <div class="container">
                <h1>Taza con nuestro Logo</h1>
                <p class="lead">Disfruta de tus bebidas con el estilo de Tractores Clavijo.</p>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12 product-detail-image">
                        <div class="main-image-wrapper">
                            <img src="../img/2.png" alt="Taza Logo Tractores Clavijo" class="img-fluid product-detail-main-img">
                        </div>
                        <div class="thumbnail-images mt-3 d-flex justify-content-center">
                            <img src="../img/2.png" alt="Miniatura Taza" class="thumbnail-img active">
                            </div>
                    </div>

                    <div class="col-lg-6 col-md-12 product-detail-info">
                        <h2 class="product-detail-title">Taza con Logo Tractores Clavijo</h2>
                        <p class="product-detail-price">$10.000 ARS</p>

                        <div class="product-detail-description">
                            <p>Esta taza de cerámica resistente es perfecta para tu café de la mañana o tu té de la tarde, mostrando con orgullo el logo de Tractores Clavijo. Un regalo ideal para cualquier fanático de la marca o para agregar a tu colección.</p>
                            <ul>
                                <li>Material: Cerámica de alta calidad.</li>
                                <li>Capacidad: 330 ml.</li>
                                <li>Diseño: Logo estampado duradero, apto para lavavajillas y microondas.</li>
                                <li>Confort: Asa ergonómica para un agarre cómodo.</li>
                            </ul>
                        </div>
