...
<head>
    ...
    <title>Llavero - Tractores Clavijo</title>
    ...
    <link rel="stylesheet" href="../merch.css" />  <link rel="stylesheet" href="llavero.css" />   </head>
<body class="merch-page"> <header>
    ...
    <main style="padding-top: var(--navbar-height);">
        ...
        <section class="merch-header">
            <div class="container">
                <h1>Llavero</h1>
                <p class="lead">Lleva la pasión por los tractores contigo a todas partes.</p>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12 product-detail-image">
                        <div class="main-image-wrapper">
                            <img src="../img/9.png" alt="Llavero Tractores Clavijo" class="img-fluid product-detail-main-img">
                        </div>
                        <div class="thumbnail-images mt-3 d-flex justify-content-center">
                            <img src="../img/9.png" alt="Miniatura Llavero" class="thumbnail-img active">
                            </div>
                    </div>

                    <div class="col-lg-6 col-md-12 product-detail-info">
                        <h2 class="product-detail-title">Llavero Metálico Tractores Clavijo</h2>
                        <p class="product-detail-price">$8.000 ARS</p>

                        <div class="product-detail-description">
                            <p>Un llavero de metal resistente con el distintivo logo de Tractores Clavijo. Ideal para organizar tus llaves o como un pequeño detalle para los amantes de la maquinaria agrícola.</p>
                            <ul>
                                <li>Material: Aleación de metal de alta resistencia.</li>
                                <li>Diseño: Grabado láser del logo Tractores Clavijo.</li>
                                <li>Durabilidad: Resistente a la corrosión y el desgaste diario.</li>
                                <li>Portabilidad: Tamaño compacto y ligero.</li>
                            </ul>
                        </div>
