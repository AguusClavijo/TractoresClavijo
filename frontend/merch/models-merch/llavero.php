...
$id_producto_actual = 9; // ID para "Llavero Logo"
$nombre_producto_actual = "Llavero Logo";
$precio_producto_actual_display = "8.000";
$imagen_producto_actual = "../img/9.png";
$descripcion_producto_lead = "Lleva la pasión por los tractores contigo a todas partes.";
$descripcion_larga_producto = "Un llavero de metal resistente con el distintivo logo de Tractores Clavijo. Ideal para organizar tus llaves o como un pequeño detalle para los amantes de la maquinaria agrícola.";
$caracteristicas_producto = [
    "Material: Aleación de metal de alta resistencia.",
    "Diseño: Grabado láser del logo Tractores Clavijo.",
    "Durabilidad: Resistente a la corrosión y el desgaste diario.",
    "Portabilidad: Tamaño compacto y ligero."
];
// Este producto no tiene talles, colores o tipo de mate seleccionables por el usuario en esta versión.
...
<head>
    ...
    <link rel="stylesheet" href="llavero.css" />
</head>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNavProductPage">
                    <ul class="navbar-nav align-items-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo (strpos($_SERVER['PHP_SELF'], 'merch.php') !== false || strpos($_SERVER['PHP_SELF'], 'llavero.php') !== false ? 'active' : ''); ?>" href="<?php echo $project_root_segment; ?>/frontend/merch/merch.php">Merch</a>
                        </li>

                        <?php if (isset($_SESSION['user_id'])): ?>
                            <li class="nav-item dropdown ms-lg-3">
                                <a class="nav-link dropdown-toggle btn btn-user-dropdown" href="#" id="navbarUserDropdownLlavero" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    Hola, <?php echo htmlspecialchars($_SESSION['user_nombre']); ?> <i class="bi bi-person-circle ms-1"></i>
                                </a>
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarUserDropdownLlavero">
            ...
            <div class="container product-detail-container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 product-detail-info">
                        <h2 class="product-detail-title">Llavero Metálico <?php echo htmlspecialchars($nombre_producto_actual); ?></h2>
