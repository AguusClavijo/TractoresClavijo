...
// $project_root_segment = "/TractoresClavijo";
...
$id_producto_actual = 10; // ID para "Mate Personalizado"
$nombre_producto_actual = "Mate Personalizado";
$precio_producto_actual_display = "35.000";
$imagen_producto_actual = "../img/10.png";
$descripcion_producto_lead = "Disfruta de la tradición con el mate exclusivo de Tractores Clavijo.";
$descripcion_larga_producto = "Este mate de calabaza o madera, con el logo grabado de Tractores Clavijo, es ideal para tus momentos de descanso y disfrute. Su diseño clásico y la calidad de sus materiales garantizan una experiencia auténtica y duradera.";
$caracteristicas_producto = [
    "Material: Calabaza natural curada o madera de algarrobo (según disponibilidad y selección).",
    "Diseño: Logo grabado a láser para un acabado premium.",
    "Confort: Forma ergonómica para un agarre cómodo.",
    "Durabilidad: Materiales resistentes y fáciles de mantener."
];
$tipos_mate_disponibles = ["Calabaza", "Madera"];
// Este producto no tiene talles ni colores seleccionables por el usuario en esta versión.
...
<body class="merch-page product-detail-page">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNavProductPage">
                    <ul class="navbar-nav align-items-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo (strpos($_SERVER['PHP_SELF'], 'merch.php') !== false || strpos($_SERVER['PHP_SELF'], 'mate.php') !== false ? 'active' : ''); ?>" href="<?php echo $project_root_segment; ?>/frontend/merch/merch.php">Merch</a>
                        </li>

                        <?php if (isset($_SESSION['user_id'])): ?>
                            <li class="nav-item dropdown ms-lg-3">
                                <a class="nav-link dropdown-toggle btn btn-user-dropdown" href="#" id="navbarUserDropdownMate" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    Hola, <?php echo htmlspecialchars($_SESSION['user_nombre']); ?> <i class="bi bi-person-circle ms-1"></i>
                                </a>
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarUserDropdownMate">
    ...
    <main style="padding-top: var(--navbar-height, 70px);">
        ...
        <section class="merch-header">
            <div class="container">
                <h1><?php echo htmlspecialchars($nombre_producto_actual); ?> con nuestro Logo</h1>
            ...
            <div class="container product-detail-container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 product-detail-info">
                        <h2 class="product-detail-title"><?php echo htmlspecialchars($nombre_producto_actual); ?> con Logo Tractores Clavijo</h2>
                        ...
                        <form action="../../../backend/php/cart_handler.php" method="POST" class="mt-4">
                            ...
                            <?php if (!empty($tipos_mate_disponibles)): ?>
                                <div class="mb-3 product-option-item">
                                    <label for="type_<?php echo $id_producto_actual; ?>" class="form-label">Tipo de Mate:</label>
                                    <select class="form-select" id="type_<?php echo $id_producto_actual; ?>" name="tipo_mate_seleccionado">
                                        <option value="" selected disabled>Seleccione un tipo</option>
                                        <?php foreach ($tipos_mate_disponibles as $tipo): ?>
