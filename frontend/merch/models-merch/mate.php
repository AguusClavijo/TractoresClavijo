...
<head>
    ...
    <title>Mate - Tractores Clavijo</title>
    ...
    <link rel="stylesheet" href="../merch.css" />  <link rel="stylesheet" href="mate.css" />   </head>
<body class="merch-page"> <header>
    ...
    <main style="padding-top: var(--navbar-height);">
        ...
        <section class="merch-header">
            <div class="container">
                <h1>Mate con nuestro Logo</h1>
                <p class="lead">Disfruta de la tradición con el mate exclusivo de Tractores Clavijo.</p>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12 product-detail-image">
                        <div class="main-image-wrapper">
                            <img src="../img/10.png" alt="Mate Logo Tractores Clavijo" class="img-fluid product-detail-main-img">
                        </div>
                        <div class="thumbnail-images mt-3 d-flex justify-content-center">
                            <img src="../img/10.png" alt="Miniatura Mate" class="thumbnail-img active">
                            </div>
                    </div>

                    <div class="col-lg-6 col-md-12 product-detail-info">
                        <h2 class="product-detail-title">Mate con Logo Tractores Clavijo</h2>
                        <p class="product-detail-price">$35.000 ARS</p>

                        <div class="product-detail-description">
                            <p>Este mate de calabaza o madera, con el logo grabado de Tractores Clavijo, es ideal para tus momentos de descanso y disfrute. Su diseño clásico y la calidad de sus materiales garantizan una experiencia auténtica y duradera.</p>
                            <ul>
                                <li>Material: Calabaza natural curada o madera de algarrobo (según stock).</li>
                                <li>Diseño: Logo grabado a láser para un acabado premium.</li>
                                <li>Confort: Forma ergonómica para un agarre cómodo.</li>
                                <li>Durabilidad: Materiales resistentes y fáciles de mantener.</li>
                            </ul>
                        </div>
