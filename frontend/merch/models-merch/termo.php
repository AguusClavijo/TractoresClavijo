...
$id_producto_actual = 3; // ID para "Termo Metálico"
$nombre_producto_actual = "Termo Metálico";
$precio_producto_actual_display = "45.000";
$imagen_producto_actual = "../img/3.png";
$descripcion_producto_lead = "Lleva tus bebidas favoritas a todas partes con estilo.";
$descripcion_larga_producto = "Mantén tus bebidas frías o calientes por horas con nuestro termo de acero inoxidable, diseñado para los que viven la pasión por Tractores Clavijo. Su durabilidad y diseño lo hacen ideal para el campo o la ciudad.";
$caracteristicas_producto = [
    "Material: Acero inoxidable de doble pared.",
    "Capacidad: 1 Litro.",
    "Tecnología: Aislamiento al vacío para máxima retención de temperatura.",
    "Confort: Pico cebador y tapa que sirve como vaso."
];
$colores_disponibles_para_este_producto = ["Negro", "Verde Oscuro", "Gris"];
// Este producto no tiene talles ni tipo de mate seleccionables.
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNavProductPage">
                    <ul class="navbar-nav align-items-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo (strpos($_SERVER['PHP_SELF'], 'merch.php') !== false || strpos($_SERVER['PHP_SELF'], 'termo.php') !== false ? 'active' : ''); ?>" href="<?php echo $project_root_segment; ?>/frontend/merch/merch.php">Merch</a>
                        </li>

                        <?php if (isset($_SESSION['user_id'])): ?>
                            <li class="nav-item dropdown ms-lg-3">
                                <a class="nav-link dropdown-toggle btn btn-user-dropdown" href="#" id="navbarUserDropdownTermo" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    Hola, <?php echo htmlspecialchars($_SESSION['user_nombre']); ?> <i class="bi bi-person-circle ms-1"></i>
                                </a>
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarUserDropdownTermo">
