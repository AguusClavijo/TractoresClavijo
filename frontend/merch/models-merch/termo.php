...
<head>
    ...
    <title>Termo - Tractores Clavijo</title>
    ...
    <link rel="stylesheet" href="../merch.css" />  <link rel="stylesheet" href="termo.css" />   </head>
<body class="merch-page"> <header>
    ...
    <main style="padding-top: var(--navbar-height);">
        ...
        <section class="merch-header">
            <div class="container">
                <h1>Termo con nuestro Logo</h1>
                <p class="lead">Lleva tus bebidas favoritas a todas partes con estilo.</p>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12 product-detail-image">
                        <div class="main-image-wrapper">
                            <img src="../img/3.png" alt="Termo Logo Tractores Clavijo" class="img-fluid product-detail-main-img">
                        </div>
                        <div class="thumbnail-images mt-3 d-flex justify-content-center">
                            <img src="../img/3.png" alt="Miniatura Termo" class="thumbnail-img active">
                            </div>
                    </div>

                    <div class="col-lg-6 col-md-12 product-detail-info">
                        <h2 class="product-detail-title">Termo con Logo Tractores Clavijo</h2>
                        <p class="product-detail-price">$45.000 ARS</p>

                        <div class="product-detail-description">
                            <p>Mantén tus bebidas frías o calientes por horas con nuestro termo de acero inoxidable, diseñado para los que viven la pasión por Tractores Clavijo. Su durabilidad y diseño lo hacen ideal para el campo o la ciudad.</p>
                            <ul>
                                <li>Material: Acero inoxidable de doble pared.</li>
                                <li>Capacidad: 1 Litro.</li>
                                <li>Tecnología: Aislamiento al vacío para máxima retención de temperatura.</li>
                                <li>Confort: Pico cebador y tapa que sirve como vaso.</li>
                            </ul>
                        </div>
