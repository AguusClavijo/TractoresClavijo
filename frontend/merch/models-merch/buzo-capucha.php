...
<head>
    ...
    <title>Buzo con Capucha - Tractores Clavijo</title>
    ...
    <link rel="stylesheet" href="../merch.css" />  <link rel="stylesheet" href="buzo-capucha.css" />   </head>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12 product-detail-image">
                        <div class="main-image-wrapper">
                            <img src="../img/4.png" alt="Buzo con Capucha Tractores Clavijo" class="img-fluid product-detail-main-img">
                        </div>
                        <div class="thumbnail-images mt-3 d-flex justify-content-center">
                            <img src="../img/4.png" alt="Miniatura Buzo con Capucha" class="thumbnail-img active">
                            </div>
                    </div>

                    <div class="col-lg-6 col-md-12 product-detail-info">
                        <h2 class="product-detail-title">Buzo con Capucha de Algodón Premium</h2>
                        <p class="product-detail-price">$40.000 ARS</p>
