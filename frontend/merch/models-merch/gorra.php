...
$id_producto_actual = 8; // ID para "Gorra Clásica"
$nombre_producto_actual = "Gorra Clásica";
$precio_producto_actual_display = "15.000";
$imagen_producto_actual = "../img/8.png";
$descripcion_producto_lead = "Protege tu cabeza con el estilo de Tractores Clavijo.";
$descripcion_larga_producto = "Esta gorra de alta calidad presenta el icónico logo de Tractores Clavijo, ideal para protegerte del sol mientras trabajas en el campo o disfrutas de actividades al aire libre. Su diseño clásico y ajuste cómodo la hacen indispensable.";
$caracteristicas_producto = [
    "Material: Algodón duradero con paneles transpirables.",
    "Diseño: Logo bordado frontal para mayor durabilidad.",
    "Confort: Correa ajustable para un ajuste perfecto.",
    "Estilo: Diseño clásico de seis paneles."
];
$colores_disponibles_para_este_producto = ["Negro", "Verde Militar", "Azul Marino"];
// Los talles no aplican para este producto, así que no definimos $talles_disponibles_para_este_producto
...
<head>
    ...
    <link rel="stylesheet" href="gorra.css" />
</head>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNavProductPage">
                    <ul class="navbar-nav align-items-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo (strpos($_SERVER['PHP_SELF'], 'merch.php') !== false || strpos($_SERVER['PHP_SELF'], 'gorra-clasica.php') !== false ? 'active' : ''); ?>" href="<?php echo $project_root_segment; ?>/frontend/merch/merch.php">Merch</a>
                        </li>

                        <?php if (isset($_SESSION['user_id'])): ?>
                            <li class="nav-item dropdown ms-lg-3">
                                <a class="nav-link dropdown-toggle btn btn-user-dropdown" href="#" id="navbarUserDropdownGorra" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    Hola, <?php echo htmlspecialchars($_SESSION['user_nombre']); ?> <i class="bi bi-person-circle ms-1"></i>
                                </a>
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarUserDropdownGorra">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 product-detail-info">
                        ...
                        <form action="../../../backend/php/cart_handler.php" method="POST" class="mt-4">
                            ...
                            <?php // La gorra no tiene talles, pero sí colores 
                            ?>
                            <?php if (!empty($colores_disponibles_para_este_producto)): ?>
