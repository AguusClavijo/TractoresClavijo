...
<head>
    ...
    <title>Campera - Tractores Clavijo</title>
    ...
    <link rel="stylesheet" href="../merch.css" />  <link rel="stylesheet" href="campera.css" />   </head>
<body class="merch-page"> <header>
    ...
    <main style="padding-top: var(--navbar-height);">
        ...
        <section class="merch-header">
            <div class="container">
                <h1>Campera de Campo</h1>
                <p class="lead">Ideal para las tareas más exigentes en el campo.</p>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12 product-detail-image">
                        <div class="main-image-wrapper">
                            <img src="../img/6.png" alt="Campera de Campo Tractores Clavijo" class="img-fluid product-detail-main-img">
                        </div>
                        <div class="thumbnail-images mt-3 d-flex justify-content-center">
                            <img src="../img/6.png" alt="Miniatura Campera" class="thumbnail-img active">
                            </div>
                    </div>

                    <div class="col-lg-6 col-md-12 product-detail-info">
                        <h2 class="product-detail-title">Campera de Trabajo Reforzada</h2>
                        <p class="product-detail-price">$45.000 ARS</p>

                        <div class="product-detail-description">
                            <p>Esta campera de trabajo está diseñada para ofrecer la máxima resistencia y comodidad. Fabricada con materiales duraderos y un diseño robusto, es perfecta para el uso diario en entornos rurales y exigentes.</p>
                            <ul>
                                <li>Material: Lona de algodón reforzada con costuras dobles.</li>
                                <li>Protección: Resistente al viento y ligera llovizna.</li>
                                <li>Comodidad: Forro interior suave y múltiples bolsillos.</li>
                                <li>Diseño: Cuello alto y puños ajustables.</li>
                            </ul>
                        </div>
