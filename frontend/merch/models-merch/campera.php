...
$id_producto_actual = 6; // ID para "Campera Básica"
$nombre_producto_actual = "Campera Básica";
$precio_producto_actual_display = "45.000";
$imagen_producto_actual = "../img/6.png";
$descripcion_producto_lead = "Ideal para las tareas más exigentes en el campo.";
$descripcion_larga_producto = "Esta campera de trabajo está diseñada para ofrecer la máxima resistencia y comodidad. Fabricada con materiales duraderos y un diseño robusto, es perfecta para el uso diario en entornos rurales y exigentes.";
$caracteristicas_producto = [
    "Material: Lona de algodón reforzada con costuras dobles.",
    "Protección: Resistente al viento y ligera llovizna.",
    "Comodidad: Forro interior suave y múltiples bolsillos.",
    "Diseño: Cuello alto y puños ajustables."
];
...
<head>
    ...
    <link rel="stylesheet" href="campera.css" />
</head>
...
<body class="merch-page product-detail-page">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNavProductPage">
                    <ul class="navbar-nav align-items-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo (strpos($_SERVER['PHP_SELF'], 'merch.php') !== false || strpos($_SERVER['PHP_SELF'], 'campera-basica.php') !== false ? 'active' : ''); ?>" href="<?php echo $project_root_segment; ?>/frontend/merch/merch.php">Merch</a>
                        </li>

                        <?php if (isset($_SESSION['user_id'])): ?>
                            <li class="nav-item dropdown ms-lg-3">
                                <a class="nav-link dropdown-toggle btn btn-user-dropdown" href="#" id="navbarUserDropdownCamperaB" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    Hola, <?php echo htmlspecialchars($_SESSION['user_nombre']); ?> <i class="bi bi-person-circle ms-1"></i>
                                </a>
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarUserDropdownCamperaB">
    ...
    <main style="padding-top: var(--navbar-height, 70px);">
        ...
        <section class="merch-header">
            <div class="container">
                <h1><?php echo htmlspecialchars($nombre_producto_actual); ?> de Campo</h1>
            ...
            <div class="container product-detail-container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 product-detail-info">
                        <h2 class="product-detail-title"><?php echo htmlspecialchars($nombre_producto_actual); ?> de Trabajo Reforzada</h2>
