...
$id_producto_actual = 1; // ID para "Remera"
$nombre_producto_actual = "Remera";
$precio_producto_actual_display = "25.000";
$imagen_producto_actual = "../img/11.png"; // Corregido a 11.png según tu lista original
$descripcion_producto_lead = "Explora las características de nuestra remera exclusiva.";
$descripcion_larga_producto = "Esta remera de algodón premium es la elección perfecta para los verdaderos entusiastas de Tractores Clavijo. Su diseño moderno y el logo icónico te permiten llevar tu pasión a donde quiera que vayas. Ideal para el uso diario o para eventos especiales.";
$caracteristicas_producto = [
    "Material: 100% Algodón peinado de alta calidad.",
    "Diseño: Estampado duradero del logo frontal.",
    "Confort: Ajuste regular, transpirable y suave al tacto.",
    "Durabilidad: Resistente al lavado y al uso continuo."
];
$talles_disponibles_para_este_producto = ["S", "M", "L", "XL", "XXL"];
$colores_disponibles_para_este_producto = ["Negro", "Blanco", "Gris Melange"]; // Colores para la remera
...
<head>
    ...
    <title><?php echo htmlspecialchars($nombre_producto_actual); ?> con nuestro Logo - Tractores Clavijo</title>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNavProductPage">
                    <ul class="navbar-nav align-items-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo (strpos($_SERVER['PHP_SELF'], 'merch.php') !== false || strpos($_SERVER['PHP_SELF'], 'remera.php') !== false ? 'active' : ''); ?>" href="<?php echo $project_root_segment; ?>/frontend/merch/merch.php">Merch</a>
                        </li>

                        <?php if (isset($_SESSION['user_id'])): ?>
                            <li class="nav-item dropdown ms-lg-3">
                                <a class="nav-link dropdown-toggle btn btn-user-dropdown" href="#" id="navbarUserDropdownRemera" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    Hola, <?php echo htmlspecialchars($_SESSION['user_nombre']); ?> <i class="bi bi-person-circle ms-1"></i>
                                </a>
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarUserDropdownRemera">
