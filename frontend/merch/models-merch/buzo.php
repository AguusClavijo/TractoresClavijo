...
<head>
    ...
    <title>Buzo Clásico - Tractores Clavijo</title>
...
<body class="merch-page">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto align-items-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="../merch.php">Merch</a>
                        </li>
                        <li class="nav-item">
    ...
    <main style="padding-top: var(--navbar-height);">
        ...
        <section class="merch-header">
            <div class="container">
                <h1>Buzo Clásico</h1>
                <p class="lead">Comodidad y estilo para tu día a día.</p>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12 product-detail-image">
                        <div class="main-image-wrapper">
                            <img src="../img/5.png" alt="Buzo Clásico Tractores Clavijo" class="img-fluid product-detail-main-img">
                        </div>
                        <div class="thumbnail-images mt-3 d-flex justify-content-center">
                            <img src="../img/5.png" alt="Miniatura Buzo" class="thumbnail-img active">
                        </div>
                    </div>

                    <div class="col-lg-6 col-md-12 product-detail-info">
                        <h2 class="product-detail-title">Buzo Clásico de Algodón</h2>
                        <p class="product-detail-price">$38.000 ARS</p>

                        <div class="product-detail-description">
                            <p>Un buzo cómodo y versátil, perfecto para cualquier ocasión. Confeccionado con algodón de alta calidad, te brindará suavidad y durabilidad. Lleva el espíritu de Tractores Clavijo contigo.</p>
                            <ul>
                                <li>Material: 80% Algodón, 20% Poliéster.</li>
                                <li>Diseño: Cuello redondo y puños acanalados.</li>
                                <li>Comodidad: Tejido suave al tacto y ajuste relajado.</li>
                                <li>Marca: Logo de Tractores Clavijo bordado.</li>
                            </ul>
                        </div>
