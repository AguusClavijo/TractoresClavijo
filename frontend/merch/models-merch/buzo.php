...
if ($path_index !== false) {
    ...
    // Caso: proyecto en la raíz de localhost (ej. localhost/frontend/merch/buzo.php)
    $project_root_segment = "";
}
...
if (isset($_SESSION['carrito']) && is_array($_SESSION['carrito'])) {
    foreach ($_SESSION['carrito'] as $item_cart_count) { // Usar una variable diferente para el bucle
...
$id_producto_actual = 5; // ID para "Buzo sin Capucha"
$nombre_producto_actual = "Buzo sin Capucha";
$precio_producto_actual_display = "38.000"; // El precio real se tomará de la BD al añadir al carrito
$imagen_producto_actual = "../img/5.png";   // Ruta relativa a la carpeta 'merch/'
$descripcion_producto_lead = "Comodidad y estilo para tu día a día.";
$descripcion_larga_producto = "Un buzo cómodo y versátil, perfecto para cualquier ocasión. Confeccionado con algodón de alta calidad, te brindará suavidad y durabilidad. Lleva el espíritu de Tractores Clavijo contigo.";
$caracteristicas_producto = [
    "Material: 80% Algodón, 20% Poliéster.",
    "Diseño: Cuello redondo y puños acanalados.",
    "Comodidad: Tejido suave al tacto y ajuste relajado.",
    "Marca: Logo de Tractores Clavijo bordado."
];
...
<head>
    ...
    <link rel="stylesheet" href="buzo.css" />
</head>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNavProductPage">
                    <ul class="navbar-nav align-items-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo (strpos($_SERVER['PHP_SELF'], 'merch.php') !== false || strpos($_SERVER['PHP_SELF'], 'buzo.php') !== false ? 'active' : ''); ?>" href="<?php echo $project_root_segment; ?>/frontend/merch/merch.php">Merch</a>
                        </li>

                        <?php if (isset($_SESSION['user_id'])): ?>
                            <li class="nav-item dropdown ms-lg-3">
                                <a class="nav-link dropdown-toggle btn btn-user-dropdown" href="#" id="navbarUserDropdownBuzo" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    Hola, <?php echo htmlspecialchars($_SESSION['user_nombre']); ?> <i class="bi bi-person-circle ms-1"></i>
                                </a>
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarUserDropdownBuzo">
            ...
            <div class="container product-detail-container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 product-detail-info">
                        <h2 class="product-detail-title"><?php echo htmlspecialchars($nombre_producto_actual); ?> de Algodón</h2>
