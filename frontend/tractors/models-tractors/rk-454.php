...
<head>
    ...
    <title>RK-454 - Tractores Clavijo</title>
    ...
    <link rel="stylesheet" href="rk-454.css" />
        ...
        <section class="product-details-section">
            <div class="row">
                <div class="col-lg-6 mb-4 mb-lg-0 d-flex justify-content-center align-items-center">
                    <img src="./fotos/rk-454.jpg" class="img-fluid product-main-image" alt="Tractor RK-454">
                </div>
                ...
                <div class="col-lg-6 product-specs-container">
                    ...
                    <ul class="specs-list">
                        ...
                        <li>Motor: Diésel 4 cilindros, 4 tiempos, inyección directa. Refrigerado por agua, tecnología Perkins.</li>
                        <li>Potencia: 45 hp</li>
                        <li>Desplazamiento: 2400 cm³</li>
                        <li>Velocidad de rotación: 2350 rpm</li>
                        <li>Número de marchas: 8 de avance / 8 de retroceso con inversor de marcha mecánico</li>
                        <li>Freno principal: Disco en baño de aceite</li>
                        <li>Toma de fuerza (PTO / rpm): 540 / 1000</li>
                        <li>Suspensión de 3 puntos: Cat. 2</li>
                        <li>Capacidad de levante a 610mm: 750 kg</li>
                        <li>Largo total: 3918 mm</li>
                        <li>Ancho total: 1600 mm</li>
                        <li>Altura total: 2420 mm</li>
                        <li>Peso: 980 Kg</li>
                    </ul>

                    <div class="pdf-section">
                        <h3 class="pdf-title">Ficha Técnica Completa (PDF)</h3>
                        <p class="pdf-model">Tractor Agrícola RK-454</p>
                        <a href="https://www.americanagro.com.ar/wp-content/uploads/2025/03/RK404-A-comprimido.pdf" target="_blank" class="btn btn-download-pdf">VER PDF</a>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 mb-4 mb-md-0">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="../../merch/merch.php"><i class="bi bi-caret-right-fill"></i> Nerch</a></li>
                    </ul>
                </div>
            </div>
