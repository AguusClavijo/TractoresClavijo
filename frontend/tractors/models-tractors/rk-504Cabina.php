...
<head>
    ...
    <title>RK-504 Cabina - Tractores Clavijo</title>
    ...
    <link rel="stylesheet" href="rk-504Cabina.css" />
...
<body>
    ...
    <section class="tractors-header text-white text-center">
        <div class="container">
            <h1>TRACTOR RK-504 CON CABINA</h1>
        ...
        <section class="product-details-section">
            <div class="row">
                <div class="col-lg-6 mb-4 mb-lg-0 d-flex justify-content-center align-items-center">
                    <img src="./fotos/rk-504C.jpg" class="img-fluid product-main-image" alt="Tractor RK-504 Cabina">
                </div>

                <div class="col-lg-6 product-specs-container">
                    <h2 class="specs-title">DETALLES TÉCNICOS</h2>
                    <ul class="specs-list">
                        <li>Tipo de motor: 4 cilindros, 4 tiempos, inyección directa</li>
                        <li>Potencia: 58 HP</li>
                        <li>Tracción: 4x4 (Doble)</li>
                        <li>Número de marchas: 8 de avance / 8 de retroceso</li>
                        <li>Freno principal: Disco en baño de aceite</li>
                        <li>Toma de fuerza (PTO): 540 / 1000 rpm</li>
                        <li>Capacidad de levante a 610 mm: 950 kg</li>
                        <li>Largo total: 3918 mm</li>
                        <li>Ancho total: 1600 mm</li>
                        <li>Altura total: 2420 mm (con cabina)</li>
                        <li>Peso: 1020 kg (con cabina)</li>
                    </ul>

                    <div class="pdf-section">
                        <h3 class="pdf-title">Ficha Técnica Completa (PDF)</h3>
                        <p class="pdf-model">Tractor Agrícola RK-504</p>
                        <a href="https://www.americanagro.com.ar/wp-content/uploads/2025/03/RK504-c-ROJO_.pdf" target="_blank" class="btn btn-download-pdf">VER PDF</a>
                    </div>
                </div>
            </div>
        </section>
