...
<head>
    ...
    <title>RK-904C (Cabina) - Tractores Clavijo</title>
    ...
    <link rel="stylesheet" href="rk-904Cabina.css" />
...
<body>
    ...
    <section class="tractors-header text-white text-center">
        <div class="container">
            <h1>TRACTOR RK-904 CON CABINA</h1>
        ...
        <section class="product-details-section">
            <div class="row">
                <div class="col-lg-6 mb-4 mb-lg-0 d-flex justify-content-center align-items-center">
                    <img src="./fotos/rk-904C.jpg" class="img-fluid product-main-image" alt="Tractor RK-904C Cabina">
                </div>
                ...
                <div class="col-lg-6 product-specs-container">
                    ...
                    <ul class="specs-list">
                        ...
                        <li>Motor: Perkins, Diesel 4 cilindros, 4 tiempos, inyección directa. Refrigerado por agua.</li>
                        <li>Potencia: 92 hp</li>
                        <li>Desplazamiento: 4500 cm³</li>
                        <li>Número de marchas: 12 F + 12 R</li>
                        <li>Velocidad min-max (avance / retroceso): 2,15-28,66 / 1,89-25,13 (Km/h)</li>
                        <li>Freno principal: A disco en baño de aceite</li>
                        <li>Toma de fuerza (PTO / rpm): 540 / 1000</li>
                        <li>Capacidad de levante a 610mm: 1450 kg</li>
                    </ul>

                    <div class="pdf-section">
                        <h3 class="pdf-title">Ficha Técnica Completa (PDF)</h3>
                        <p class="pdf-model">Tractor Agrícola RK-904 con Cabina</p>
                        <a href="https://www.americanagro.com.ar/wp-content/uploads/2025/01/RK904-C-ROJO-comprimido.pdf" target="_blank" class="btn btn-download-pdf">VER PDF</a>
                    </div>
                </div>
            </div>
        </section>
