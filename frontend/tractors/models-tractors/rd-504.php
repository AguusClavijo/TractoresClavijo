...
<head>
    ...
    <title>RD-504 - Tractores Clavijo</title>
    ...
    <link rel="stylesheet" href="rd-504.css" />
        ...
        <section class="product-details-section">
            <div class="row">
                <div class="col-lg-6 mb-4 mb-lg-0 d-flex justify-content-center align-items-center">
                    <img src="./fotos/rd-504.jpg" class="img-fluid product-main-image" alt="Tractor RD 504">
                </div>
                ...
                <div class="col-lg-6 product-specs-container">
                    ...
                    <ul class="specs-list">
                        ...
                        <li>Motor: Diésel 4 cilindros, 4 tiempos, inyección directa. Refrigerado por agua.</li>
                        <li>Tecnología: Perkins</li>
                        <li>Potencia: 58 hp</li>
                        <li>Desplazamiento: 1833 cm3</li>
                        <li>Capacidad de tanque de combustible: 55L</li>
                        <li>Freno principal: Disco seco</li>
                        <li>Capacidad de levante a 610mm: 833 kg</li>
                    </ul>

                    <div class="pdf-section">
                        <h3 class="pdf-title">Ficha Técnica Completa (PDF)</h3>
                        <p class="pdf-model">Tractor Agrícola RD504</p>
                        <a href="https://www.americanagro.com.ar/wp-content/uploads/2025/03/RD504-F-comprimido.pdf" target="_blank" class="btn btn-download-pdf">VER PDF</a>
                    </div>
                </div>
            </div>
        </section>
