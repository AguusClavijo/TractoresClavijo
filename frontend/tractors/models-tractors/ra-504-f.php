...
<head>
    ...
    <title>RA-254 - Tractores Clavijo</title>
    ...
    <link rel="stylesheet" href="ra-504-f.css" />
        ...
        <section class="product-details-section">
            <div class="row">
                <div class="col-lg-6 mb-4 mb-lg-0 d-flex justify-content-center align-items-center">
                    <img src="./fotos/ra-504f.jpg" class="img-fluid product-main-image" alt="Tractor RA 254">
                </div>
                ...
                <div class="col-lg-6 product-specs-container">
                    ...
                    <ul class="specs-list">
                        ...
                        <li>Motor Diesel 4 cilindros, inyección Directa, bomba Lineal Refrigerado por agua</li>
                        <li>Potencia: 58 hp</li>
                        <li>Desplazamiento: 1255 cm3</li>
                        <li>Velocidad de rotación: 3100 rpm</li>
                        <li>Número de marchas: 8 de avance / 2 de retroceso</li>
                        <li>Velocidad min-max (avance / retroceso): 2,35 - 33 / 2,06 - 27 Km/h</li>
                        <li>Freno principal: Disco seco</li>
                        <li>Capacidad de levante a 610mm: 720 kg</li>
                        <li>Peso: 1700 Kg</li>
                    </ul>

                    <div class="pdf-section">
                        <h3 class="pdf-title">Ficha Técnica Completa (PDF)</h3>
                        <p class="pdf-model">Tractor Viñatero RA 504F</p>
                        <a href="https://www.americanagro.com.ar/wp-content/uploads/2025/03/RA504-F-comprimido.pdf" target="_blank" class="btn btn-download-pdf">VER PDF</a>
                    </div>
                </div>
            </div>
        </section>
