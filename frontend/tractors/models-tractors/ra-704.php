...
<head>
    ...
    <title>RA-704 - Tractores Clavijo</title>
    ...
    <link rel="stylesheet" href="ra-704.css" />
        ...
        <section class="product-details-section">
            <div class="row">
                <div class="col-lg-6 mb-4 mb-lg-0 d-flex justify-content-center align-items-center">
                    <img src="./fotos/ra-704.jpg" class="img-fluid product-main-image" alt="Tractor RA 704">
                </div>
                ...
                <div class="col-lg-6 product-specs-container">
                    ...
                    <ul class="specs-list">
                        ...
                        <li>Potencia: 75 hp</li>
                        <li>Desplazamiento: 3100 cm3</li>
                        <li>Cap. de tanque de combustible: 38L</li>
                    ...
                    <div class="pdf-section">
                        ...
                        <p class="pdf-model">Tractor Agrícola RA704F</p>
                        <a href="https://www.americanagro.com.ar/wp-content/uploads/2025/03/RA704-F-comprimido-.pdf" target="_blank" class="btn btn-download-pdf">VER PDF</a>
                    </div>
                </div>
            </div>
        </section>
