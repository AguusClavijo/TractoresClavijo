...
<head>
    ...
    <title>RK-504 Techo - Tractores Clavijo</title>
    ...
    <link rel="stylesheet" href="rk-504Techo.css" />
...
<body>
    ...
    <section class="tractors-header text-white text-center">
        <div class="container">
            <h1>TRACTOR RK-504 CON TECHO</h1>
        ...
        <section class="product-details-section">
            <div class="row">
                <div class="col-lg-6 mb-4 mb-lg-0 d-flex justify-content-center align-items-center">
                    <img src="./fotos/rk-504T.jpeg" class="img-fluid product-main-image" alt="Tractor RK-504 Techo">
                </div>
                ...
                <div class="col-lg-6 product-specs-container">
                    ...
                    <ul class="specs-list">
                        ...
                        <li>Altura total: 2420 mm (con techo)</li>
                        <li>Peso: 1020 kg (con techo)</li>
                    </ul>
