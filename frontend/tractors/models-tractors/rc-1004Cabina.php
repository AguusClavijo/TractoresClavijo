...
<head>
    ...
    <title>RC-1004 (Cabina) - Tractores Clavijo</title>
    ...
    <link rel="stylesheet" href="rc-1004Cabina.css" />
...
<body>
    ...
    <section class="tractors-header text-white text-center">
        <div class="container">
            <h1>TRACTOR RC-1004 CON CABINA</h1>
        ...
        <section class="product-details-section">
            <div class="row">
                <div class="col-lg-6 mb-4 mb-lg-0 d-flex justify-content-center align-items-center">
                    <img src="./fotos/rc-1004C.jpg" class="img-fluid product-main-image" alt="Tractor RC-1004 Cabina">
                </div>
                ...
                <div class="col-lg-6 product-specs-container">
                    ...
                    <ul class="specs-list">
                        ...
                        <li>Potencia: 105 HP</li>
                        <li>Cilindrada: 4070 cm³</li>
                        <li>Velocidad de giro: 2300 rpm</li>
                        <li>Número de marchas: 16 adelante / 8 atrás</li>
                        <li>Velocidad min-max (avance / retroceso): 2.19 - 29.41 / 4.72 - 13.47 Km/h</li>
                    ...
                    <div class="pdf-section">
                        ...
                        <p class="pdf-model">Tractor Agrícola RC-1004 con Cabina</p>
                        <a href="https://www.americanagro.com.ar/wp-content/uploads/2025/03/RC1004-C-comprimido-.pdf" target="_blank" class="btn btn-download-pdf">VER PDF</a>
                    </div>
                </div>
            </div>
        </section>
