...
<head>
    ...
    <title>RC-1404C - Tractores Clavijo</title>
    ...
    <link rel="stylesheet" href="rc-1404.css" />
        ...
        <section class="product-details-section">
            <div class="row">
                <div class="col-lg-6 mb-4 mb-lg-0 d-flex justify-content-center align-items-center">
                    <img src="./fotos/rc-1404C.jpg" class="img-fluid product-main-image" alt="Tractor RC-1404C">
                </div>
                ...
                <div class="col-lg-6 product-specs-container">
                    ...
                    <ul class="specs-list">
                        ...
                        <li>Motor: Diesel 6 cilindros, 4 tiempos, inyección directa, refrigerado por agua, tecnología Perkins.</li>
                        <li>Potencia: 140 Hp</li>
                        <li>Cilindrada: 4070 cm³</li>
                        <li>Número de marchas: 24x24</li>
                        <li>Rodado: 13.6-24 / 16.9-34 (Delantero / Trasero)</li>
                        <li>Rodado (Opcional): 14.9-26 / 16.9-38 (Delantero / Trasero)</li>
                        <li>Capacidad del tanque de combustible: 92L</li>
                        <li>Peso: 3750 Kg</li>
                    </ul>

                    <div class="pdf-section">
                        <h3 class="pdf-title">Ficha Técnica Completa (PDF)</h3>
                        <p class="pdf-model">Tractor Agrícola RC-1404</p>
                        <a href="https://www.americanagro.com.ar/wp-content/uploads/2024/12/RC1404-C-ROJO-comprimido.pdf" target="_blank" class="btn btn-download-pdf">VER PDF</a>
                    </div>
                </div>
            </div>
        </section>
