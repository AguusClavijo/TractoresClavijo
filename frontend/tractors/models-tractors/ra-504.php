...
<head>
    ...
    <title>RA-504 - Tractores Clavijo</title>
    ...
    <link rel="stylesheet" href="ra-504.css" />
        ...
        <section class="product-details-section">
            <div class="row">
                <div class="col-lg-6 mb-4 mb-lg-0 d-flex justify-content-center align-items-center">
                    <img src="./fotos/ra-504.jpg" class="img-fluid product-main-image" alt="Tractor RA 504">
                </div>

                <div class="col-lg-6 product-specs-container">
                    <h2 class="specs-title">DETALLES TÉCNICOS</h2>
                    <ul class="specs-list">
                        <li>Tracción Doble 4x2</li>
                        <li>Motor Diesel 4 cilindros, 4 tiempos, inyección directa, Refrigerado por agua</li>
                        <li>Potencia: 58 HP</li>
                        <li>Desplazamiento: 3000 cm3</li>
                        <li>Cap. de tanque de combustible: 60L</li>
                        <li>Toma de fuerza (PTO/rpm): -</li>
                        <li>Distancia entre ejes: 900 mm</li>
                        <li>Capacidad de levante a 610mm: 720 kg</li>
                    </ul>

                    <div class="pdf-section">
                        <h3 class="pdf-title">Ficha Técnica Completa (PDF)</h3>
                        <p class="pdf-model">Tractor Viñatero RA504</p>
                        <a href="https://www.americanagro.com.ar/wp-content/uploads/2025/03/RA500-A-comprimido-.pdf" target="_blank" class="btn btn-download-pdf">VER PDF</a>
                    </div>
                </div>
            </div>
        </section>
