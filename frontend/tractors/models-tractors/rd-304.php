...
<head>
    ...
    <title>RD-304 - Tractores Clavijo</title>
    ...
    <link rel="stylesheet" href="rd-304.css" />
        ...
        <section class="product-details-section">
            <div class="row">
                <div class="col-lg-6 mb-4 mb-lg-0 d-flex justify-content-center align-items-center">
                    <img src="./fotos/rd-304.jpg" class="img-fluid product-main-image" alt="Tractor RD 304">
                </div>

                <div class="col-lg-6 product-specs-container">
                    <h2 class="specs-title">DETALLES TÉCNICOS</h2>
                    <ul class="specs-list">
                        <li>Tracción: Simple 4x2, con opción 4x4</li>
                        <li>Motor: Diésel, 3 cilindros, 4 tiempos, inyección directa, refrigerado por agua</li>
                        <li>Potencia: 30 hp</li>
                        <li>Desplazamiento: 1533 cm3</li>
                        <li>Marchas: 8 de avance / 2 de retroceso</li>
                        <li>Velocidad (avance/retroceso): 1.71 - 26 / 2.05 - 7.20 km/h</li>
                        <li>Freno principal: Disco seco</li>
                        <li>Toma de fuerza (PTO): 540 / 1000 rpm</li>
                        <li>Capacidad de levante a 610mm: 433 kg</li>
                    </ul>

                    <div class="pdf-section">
                        <h3 class="pdf-title">Ficha Técnica Completa (PDF)</h3>
                        <p class="pdf-model">Tractor Agrícola RD 304</p>
                        <a href="https://www.americanagro.com.ar/wp-content/uploads/2025/03/RD300-A-comrimido-.pdf" target="_blank" class="btn btn-download-pdf">VER PDF</a>
                    </div>
                </div>
            </div>
        </section>
