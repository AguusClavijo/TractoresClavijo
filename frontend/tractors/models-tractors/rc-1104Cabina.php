...
<head>
    ...
    <title>RC-1104 (Cabina) - Tractores Clavijo</title>
    ...
    <link rel="stylesheet" href="rc-1104Cabina.css" />
...
<body>
    ...
    <section class="tractors-header text-white text-center">
        <div class="container">
            <h1>TRACTOR RC-1104 CON CABINA</h1>
        ...
        <section class="product-details-section">
            <div class="row">
                <div class="col-lg-6 mb-4 mb-lg-0 d-flex justify-content-center align-items-center">
                    <img src="./fotos/rc-1104C.jpg" class="img-fluid product-main-image" alt="Tractor RC-1104 Cabina">
                </div>
                ...
                <div class="col-lg-6 product-specs-container">
                    ...
                    <div class="pdf-section">
                        ...
                        <p class="pdf-model">Tractor Agrícola RC-1104 con Cabina</p>
