...
<head>
    ...
    <title>RK-904C (Techo) - Tractores Clavijo</title>
    ...
    <link rel="stylesheet" href="rk-904Techo.css" />
...
<body>
    ...
    <section class="tractors-header text-white text-center">
        <div class="container">
            <h1>TRACTOR RK-904 CON TECHO</h1>
        ...
        <section class="product-details-section">
            <div class="row">
                <div class="col-lg-6 mb-4 mb-lg-0 d-flex justify-content-center align-items-center">
                    <img src="./fotos/rk-904T.jpg" class="img-fluid product-main-image" alt="Tractor RK-904C Techo">
                </div>
                ...
                <div class="col-lg-6 product-specs-container">
                    ...
                    <div class="pdf-section">
                        ...
                        <p class="pdf-model">Tractor Agrícola RK-904 con Techo</p>
